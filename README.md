...
**Security Note:** To ensure transparency and trust, all pre-compiled binaries are built automatically by/on GitHub with a feature called Workflow. *No binaries are uploaded from personal machines.* You can verify GitHub's compile log by clicking the **Actions** tab at the top of this repository.
